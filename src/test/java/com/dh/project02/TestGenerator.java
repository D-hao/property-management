...
/**
 * @Auther:D-hao
 * @Date:2020/11/9-11-09-19:33
 * @Description:com.dh.project01
 */
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("lian")
                .setOutputDir("C:\\Users\\86187\\IdeaProjects\\project02\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/project?serverTimezone=UTC")
        ...
        packageConfig.setParent("com.dh").setMapper("mapper")
